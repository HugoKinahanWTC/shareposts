            ...
            <form action="<?php echo URLROOT; ?>/users/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control
                        form-control-lg <?php echo (!empty
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirm_password" class="form-control form-control-lg <?php echo
                               (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo
                        htmlspecialchars($data['confirm_password']); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-light btn-block mt-3">Have an
                            account? Login</a>
                    </div>
                </div>
            </form>
